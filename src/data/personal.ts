export const personal = {
  ...
  phone: "+1 (716) 303-9437",
  location: "Buffalo, New York",
  resumeSummary:
    "Pharmaceutical scientist with graduate research in developing protein-loaded lipid nanoparticles for therapeutic immune modulation. Hands-on with LNP formulation, process scale-up strategies, and biophysical characterization using SEC, HPLC, circular dichroism, intrinsic fluorescence, and dynamic light scattering. Experienced in mammalian cell culture, ELISA, cell viability assays, and aseptic technique. Background in analytical method development using DoE, GMP-aligned manufacturing, and presenting data-driven results to cross-functional research teams.",
} as const;
